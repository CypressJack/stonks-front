...
storiesOf("News", module)
  .add("ArticleList", () => <StylesProvider injectFirst><ArticleList news={news}></ArticleList></StylesProvider>)
  .add("ListItem", () => <StylesProvider injectFirst><ListItem img={article.image} headline={article.headline} dateTime={article.datetime} summary={article.summary}></ListItem></StylesProvider>)
