...
storiesOf("Button", module)
  ...
  .add("Sell", () => <StylesProvider injectFirst><Button sell className="red-button" onClick={action("Button Clicked!")}>Sell</Button></StylesProvider> )
  .add("Tutorial", () => <StylesProvider injectFirst><Button tutorial className="MuiButton-tutorial" onClick={action("Button Clicked!")} completed={false}>Tutorial 1.</Button></StylesProvider>)
  .add("Completed tutorial", () => <StylesProvider injectFirst><Button tutorial className="MuiButton-tutorial" onClick={action("Button Clicked!")} completed={true} >Tutorial 1.</Button></StylesProvider>);
